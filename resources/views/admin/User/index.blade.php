                                        ...
                                        <tbody>
                                            @foreach ($user as $item)
                                                <tr>
                                                    ...
                                                    <td class="text-center px-2">
                                                        <input type="checkbox" class="toggle-status" data-id="{{ $item->id }}" {{ $item->is_active ? 'checked' : '' }} data-toggle="toggle" data-onstyle="success" data-offstyle="danger" data-width="60" data-height="30">
                                                    </td>
                                                    <td class="text-center px-2">
